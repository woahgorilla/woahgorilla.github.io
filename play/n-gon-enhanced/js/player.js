...
const m = {
    ...
    },
    {
        ...
        description: "use <strong class='color-f'>energy</strong> to become invulnerable<br>you cannot attack while shielding.<br><strong>7</strong> <strong class='color-f'>energy</strong> per second",
        effect: () => {
            m.fieldMeterColor = "#09f5a6"
            m.grabPowerUpRange2 = 10000000
            m.fieldPosition = { x: simulation.mouse.x, y: simulation.mouse.y }
            m.fieldAngle = m.angle
            m.fieldRegen = 0.002
            m.grabPowerUpRange2 = 100000
            m.hold = function () {
                if (m.isHolding) {
                    m.drawHold(m.holdingTarget);
                    m.holding();
    ...
    },
    {
        ...
        description: `use <strong class='color-f'>energy</strong> to <strong>teleport</strong> to mouse position (Crouch to teleport)<br>use <strong class='color-f'>energy</strong> to <strong>deflect</strong> mobs<br><strong>6</strong> <strong class='color-f'>energy</strong> per second`,
        effect: () => {
            m.fieldMeterColor = "#ff0"
            m.eyeFillColor = m.fieldMeterColor
            m.hold = function () {
